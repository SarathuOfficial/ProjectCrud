    ...
    <div class="container">
        ...
        <div id="update" class="tab-content">
            ...
            <form action="UpdateProject" method="post" enctype="multipart/form-data">
                ...
                <input type="text" id="updateProjectName" name="projectName" required>

                <label for="updateProjectDescription">Project Description</label>
                <textarea id="updateProjectDescription" name="projectDescription" rows="4" required></textarea>
                ...
                <input type="number" step="0.01" id="updateBudget" name="budget" required>
        ...
        <div id="delete" class="tab-content">
            ...
            <input type="text" id="deleteProjectId" name="projectId" required placeholder="Enter Project ID">
